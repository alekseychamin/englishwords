...
namespace ConsoleTelegramBot.States
{
    public class InputTranslateState : IState
    {
        ...
        public InputTranslateState(IState nextState, bool isInitialize = true)
        {
            NextState = nextState;
        ...
        {
            uniqueChatId.SetTranslate(ChatId, message);
        ...
        {
            await _configuration.SendMessageCommand.Execute(ChatId, "Input translate:", ParseMode.Html, new ReplyKeyboardRemove());
        }
    }
}
