...
namespace ConsoleTelegramBot.States
{
    public class EditTranslateState : IState
    {
        ...
        public EditTranslateState(IState nextState, bool isInitialize = true)
        {
            NextState = nextState;
        ...
        public async Task ChangeState(IUniqueChatId uniqueChatId, string message)
        {
            ...
            {
                var field = uniqueChatId.GetTranslate(ChatId);
                ...
                var inputWordNameState = new InputTranslateState(this, isInitialize: false);
        ...
        {
            await _configuration.Operation.MakeQuestion(ChatId, "Do you need to edit translate?", _configuration);
        }
    }
}
