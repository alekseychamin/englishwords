...
namespace ConsoleTelegramBot.States
{
    public class EditExampleState : IState
    {
        ...
        public EditExampleState(IState nextState, bool isInitialize = true)
        {
            NextState = nextState;
        ...
        public async Task ChangeState(IUniqueChatId uniqueChatId, string message)
        {
            ...
            {
                var field = uniqueChatId.GetExample(ChatId);
                ...
                var inputWordNameState = new InputExampleState(this, isInitialize: false);
        ...
        {
            await _configuration.Operation.MakeQuestion(ChatId, "Do you need to edit example?", _configuration);
        }
    }
}
