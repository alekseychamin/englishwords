...
{
    public class EditWordCommandTests
    {
        ...
        public async Task ExecuteCommandTest(long chatId)
        {
            ...
            var command = new EditWordCommand("/test", "test", configuration,
        ...
        public async Task SaveInfoFromUser_StateNull_Test(long chatId, string message)
        {
            ...
            inputState.Setup(x => x.ChangeState(It.IsAny<IUniqueChatId>(), It.IsAny<string>()))
                                  .Callback(() => 
                                  {
                                      command.EnglishWordFromUser.Add(chatId, new NewEnglishWord());
            ...
            operationMock.Verify(x => x.EditEnglishWord(It.IsAny<long>(), It.IsAny<int>(), It.IsAny<NewEnglishWord>(), 
