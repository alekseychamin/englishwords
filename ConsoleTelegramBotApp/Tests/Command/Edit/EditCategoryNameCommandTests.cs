...
{
    public class EditCategoryNameCommandTests
    {
        ...
        public async Task ExecuteCommandTest(long chatId)
        {
            ...
            var command = new EditCategoryNameCommand("/test", "test", configuration,
        ...
        public async Task SaveInfoFromUser_StateNull_Test(long chatId, string message)
        {
            ...
            inputState.Setup(x => x.ChangeState(It.IsAny<IUniqueChatId>(), It.IsAny<string>()))
                        .Callback(() => 
                        {
                            command.SetCategoryName(chatId, message);
            ...
            operationMock.Verify(x => x.EditCategory(It.IsAny<long>(), It.IsAny<int>(), It.IsAny<NewCategory>(), 
